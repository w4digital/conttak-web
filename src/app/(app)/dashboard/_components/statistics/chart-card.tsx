...
export default function Chart01({ className }: ChartCardProps) {
    const Countries = [
        {
            id: 1,
            title: "Earning",
    ...
    return (
        <Card className={cn("w-full max-w-[90dvw] mx-auto py-6 gap-8 shadow-xs", className)}>
            <CardHeader className="flex sm:flex-row flex-col justify-between sm:items-center items-start gap-3 px-6">
                <div className="flex flex-col gap-1">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Badge
                            className={cn(
                                "bg-primary/10 text-muted-foreground shadow-none"
                            )}
                        >
                            +18%
                        </Badge>
